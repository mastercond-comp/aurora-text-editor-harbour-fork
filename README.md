...
- не нравится диалог записи файла (Сорханить как), там приходится чуть ли не вручную прописывать путь к сохраняемому файлу, что естественно требует переделки
<br><br>
